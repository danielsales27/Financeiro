...
namespace Financeiro.Web.Controllers
{
    public class ReceitasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Receita_Id,Nome,Valor,Categoria,Data,Observacao")] Receita receita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Receita_Id,Nome,Valor,Categoria,Data,Observacao")] Receita receita)
        {
            if (ModelState.IsValid)
            {
